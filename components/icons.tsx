...
export const RocketLaunchIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="m15.58 14.37-2.16-2.16m2.16 2.16-.92 2.02a1.12 1.12 0 0 1-1.92 0l-.92-2.02m2.84 0-2.16-2.16m0 0L10.63 5.29a1.12 1.12 0 0 1 0-1.92l2.02-.92a1.12 1.12 0 0 1 1.92 0l2.02.92a1.12 1.12 0 0 1 0 1.92l-5.29 5.29m-2.84 0-2.16-2.16m2.16 2.16-2.16 2.16" />
    </svg>
);

export const LockOpenIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75M10.5 21l5.25-5.25M10.5 21V11.25m0 0-5.25 5.25M10.5 11.25l5.25-5.25" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 11.25a2.25 2.25 0 0 0-2.25-2.25m0 0a2.25 2.25 0 0 0-2.25 2.25m2.25 2.25a2.25 2.25 0 0 1 2.25 2.25m0 0a2.25 2.25 0 0 1-2.25 2.25m-2.25-2.25a2.25 2.25 0 0 0 2.25-2.25" />
    </svg>
);
